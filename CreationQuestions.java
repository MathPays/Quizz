...
public class CreationQuestions {
    ...
    public static ArrayList<Theme> creationQuestions() {
        ...
        cinema.add(c2);
        RC c3 = new RC("Quels sont les inventeur du cinéma ?",1,"Les Frères Lumières");
        cinema.add(c3);
        ...
        cinema.add(c5);
        RC c6 = new RC("Combien de film la saga Destination Finale compte-t-elle à l'heure actuelle ?",2,"5");
        cinema.add(c6);
        ...
        c8.addReponse("Il se met à begayer");
        ...
        QCM l1 = new QCM("Qui a écris Bel Ami ?",1);
        l1.addReponse("Guy de Maupassant");
        l1.addReponse("Gustave Flaubert");
        l1.addReponse("Emile Zola");
        l1.addReponse("Charles Beaudelaire");
        lit.add(l1);
        QCM l2 = new QCM("Quel livre a été par Stephen King ?",1);
        l2.addReponse("Misery");
        l2.addReponse("Gone Girl");
        l2.addReponse("Ne t'éloigne pas");
        l2.addReponse("Dark Places");
        lit.add(l2);
        RC l3 = new RC("Comment s'appelle le célèbre ensemble de texte écrit par Honoré de Balzac ?",1,"La Comédie Humaine");
        lit.add(l3);
        VF l4 = new VF("Louis Aragon a écris le receuil Les Fleurs du Mal",1,false);
        lit.add(l4);
        ...
        lit.add(l6);
        VF l7 = new VF("Howard Philip Lovecraft a écris L'Appel de Cthullu",2,true);
        lit.add(l7);

        RC l8 = new RC("Qui a écris le livre Gone Girl, ayant inspiré le film éponyme de David Fincher ?",3,"Gillian Flyn");
        lit.add(l8);
